...
describe DrLight::ScientificNumber do
  ...
  describe '#to_s' do
    ...
    context 'when deviance has bigger order than the value' do
      ...
      xcontext 'when negative number has 3 digits and order 10^2' do
        let(:value)    { -123 }
        let(:deviance) { 1.34 }
      ...
      xcontext 'when negative number only has 2 digits and order 1' do
        let(:value)    { -1.2 }
        let(:deviance) { 0.013 }
      ...
      xcontext 'when negative number has 3 digits and order 1' do
        let(:value)    { -1.23 }
        let(:deviance) { 0.0134 }
      ...
      xcontext 'when negative number only has 2 digits and order 10^-1' do
        let(:value)    { -0.12 }
        let(:deviance) { 0.0013 }
      ...
      xcontext 'when negative number has 3 digits and order 10^-1' do
        let(:value)    { -0.123 }
        let(:deviance) { 0.00134 }
      ...
      xcontext 'when positive number only has 2 digits and order 10' do
        let(:value)    { 12 }
        let(:deviance) { 0.13 }
      ...
      xcontext 'when positive number has 3 digits and order 10^2' do
        let(:value)    { 123 }
        let(:deviance) { 1.34 }
      ...
      xcontext 'when positive number only has 2 digits and order 1' do
        let(:value)    { 1.2 }
        let(:deviance) { 0.013 }
      ...
      xcontext 'when positive number has 3 digits and order 1' do
        let(:value)    { 1.23 }
        let(:deviance) { 0.0134 }
      ...
      xcontext 'when positive number only has 2 digits and order 10^-1' do
        let(:value)    { 0.12 }
        let(:deviance) { 0.0013 }
      ...
      xcontext 'when positive number has 3 digits and order 10^-1' do
        let(:value) { 0.123 }
        let(:deviance) { 0.00134 }
